param(
    ...
    [string]$NotionUrl = "local://notion/monthly-dry-run"
)
...
$LogFile = Join-Path $LogsDir "hermes-monthly-$Timestamp.log"
$ArgsList = @("scripts\run_monthly_intelligence.py", "--notion-url", $NotionUrl)
