# Intelligence Hub Documentation

Intelligence Hub is the platform. Hermes is an optional research-agent integration and compatibility layer.

Start here:

- `docs/QUICKSTART.md` for the zero-secret demo
- `docs/DEMO.md` for seeded fixture data and Obsidian export
- `docs/ARCHITECTURE.md` for runtime, repository, proposal, API, Dashboard, and Obsidian seams
